...
export const Footer = () => {
  ...
  const socialLinks = [
    { title: 'X', href: 'https://x.com', icon: <XIcon className="h-5 w-5" /> },
    { title: 'Telegram', href: 'https://t.me', icon: <TelegramIcon className="h-5 w-5" /> },
    { title: 'Discord', href: 'https://discord.com', icon: <DiscordIcon className="h-5 w-5" /> },
  ];
